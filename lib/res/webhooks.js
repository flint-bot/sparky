    ...
    let webhookHandler = function(req, res, next) {
      ...
      let processBody = function(bodyObj) {
        ...
        if(_resource && _event && _data) {
           ...
           *
           * @event memberships
           * @property {String} Triggered event (created, updated, deleted)
           * @property {Object.<Membership>} Membership Object found in Webhook
           * @property {Object.<Request>} Full Request Object
           *
           */
           ...
           *
           * @event messages
           * @property {String} Triggered event (created, deleted)
           * @property {Object.<Message>} Message Object found in Webhook
           * @property {Object.<Request>} Full Request Object
           */
           ...
           *
           * @event rooms
           * @property {String} Triggered event (created, updated)
           * @property {Object.<Room>} Room Object found in Webhook
           * @property {Object.<Request>} Full Request Object
           */
