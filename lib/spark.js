 ...
 *   });
 */
Spark.prototype.roomUpdate = function(room) {
  // if room object is valid
  if(room && typeof room === 'object' && validator.isRoom(room)) {
    // update the room
    return this.request('put', 'rooms', room.id, room)
      .then(res => this.toObject(res));
  }
 ...
 *   });
 */
Spark.prototype.personUpdate = function(person) {
  // if person object is valid
  if(person && typeof person === 'object' && validator.isPerson(person)) {
    // update the person
    return this.request('put', 'people', person.id, person)
      .then(res => this.toObject(res));
  }
 ...
 *   });
 */
Spark.prototype.teamUpdate = function(team) {
  // if team object is valid
  if(team && typeof team === 'object' && validator.isTeam(team)) {
    // update the team
    return this.request('put', 'people', team.id, team)
      .then(res => this.toObject(res));
  }
 ...
 *   });
 */
Spark.prototype.teamMembershipUpdate = function(teamMembership) {
  ...
  if(teamMembership && typeof teamMembership === 'object' && validator.isTeamMembership(teamMembership)) {
    ...
    return this.request('put', 'people', teamMembership.id, teamMembership)
      .then(res => this.toObject(res));
  }
 ...
 *   });
 */
Spark.prototype.membershipUpdate = function(membership) {
  // if membership object is valid
  if(membership && typeof membership === 'object' && validator.isMembership(membership)) {
    // update the membership
    return this.request('put', 'memberships', membership.id, membership)
      .then(res => this.toObject(res));
  }
 ...
 *   });
 */
Spark.prototype.webhookUpdate = function(webhook) {
  // if webhook object is valid
  if(webhook && typeof webhook === 'object' && validator.isWebhook(webhook)) {
    // update the webhook
    return this.request('put', 'webhooks', webhook.id, webhook)
      .then(res => this.toObject(res));
  }
